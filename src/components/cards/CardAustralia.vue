  ...
  <q-card class="text-white" :style="{'background-image': background_image}">
    ...
    <q-card-section>
      <div class="text-h6 text-weight-bolder text-center">
        Manage any number of trade marks registered with IP Australia
      </div>
    </q-card-section>
    <q-separator/>
    <q-card-section class="text-center">
      Integration with IP Australia
    </q-card-section>
    <q-separator/>
    <q-card-section class="text-center">
      OAuth Security
    ...
    <q-separator/>
    <q-card-section class="text-center">
      Watchlist and Domain searching
    </q-card-section>
    <q-separator/>
    <q-card-section class="text-center">
      Calendar
    ...
    <q-card-actions vertical align="center">
      <q-btn class="text-capitalize bg-indigo-8" color="">Register with Credit Card</q-btn>
    </q-card-actions>
    <q-separator/>
    <q-card-section class="text-center">
      Watch Intro Video
